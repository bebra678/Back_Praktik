    ...
    <?php
        ...
        { ?>
            <form action="" method="post" class="login-form" enctype="multipart/form-data">
                ...
                <input name="type_post" type="hidden" value="sub"/><br>
                <br><button class="lock" value="sub"><?= $el->name ?></button>
            </form>
        <?php }
    ?>
        ...
        for($i = 1; $i <= count($dis_unique); $i++)
        {
            ...
            { ?>
                <form action="" method="post" class="login-form" enctype="multipart/form-data">
                    <input name="csrf_token" type="hidden" value="<?= app()->auth::generateCSRF() ?>"/><br>
                    <input name="id" type="hidden" value="<?= $el->id ?>"/><br>
                    <input name="type_post" type="hidden" value="dis1"/><br>
                    <br><button class="block7" value="dis1"><?= $el->name ?></button>
                </form>
            <?php }
        }
    }
